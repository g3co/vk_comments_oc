...
################################################################################################
class ModelModuleVkComments extends Model {
	...
	public function createModuleTables() {
		$query = $this->db->query("CREATE TABLE IF NOT EXISTS " . DB_PREFIX . "vkcomments (limitmessages INT(11) AUTO_INCREMENT, sort_order INT(3), status INT(1), date DATE, PRIMARY KEY (limitmessages))");
	}	
}
?>